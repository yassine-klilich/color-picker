      ...
      case "ArrowUp": {
        switch (this.currentRepresentation) {
          case RGB: {
            ...
            if (r < 255) {
              target.value = ++r
              const { h, s, v } = this.color.RGBtoHSV(r, g, b)
              this.color.h = h
              this.color.s = s
              this.color.v = v
              _updateColorView.call(this)
    ...
    switch (this.currentRepresentation) {
      case RGB: {
        ...
        if(isNaN(value) || value < 0 || value > 255) {
          ...
          const { h, s, v } = this.color.RGBtoHSV(value, g, b)
          this.color.hsv.h = h
          this.color.hsv.s = s
          this.color.hsv.v = v
          _updateColorView.call(this)
...
function _onKeyDownInputB(event) {
  ...
  //        case HSL: {
  //          const { s, l } = this.color.toHSL()
  //          let hsl_s = Math.round(s)
  //          if (s < 100) {
  //            target.value = ++hsl_s + "%"
  //            const d = this.color.HSLtoHSV(this.color.h, hsl_s, l)
  //            this.color.s = d.s
  //            _updateColorView.call(this)
  //          }
  //        } break
  ...
  //        case HSL: {
  //          const { s, l } = this.color.toHSL()
  //          let hsl_s = Math.floor(s)
  //          if (hsl_s > 0) {
  //            target.value = --hsl_s + "%"
  //            const { s } = this.color.HSLtoHSV(this.color.h, hsl_s, l)
  //            this.color.s = s
  //            _updateColorView.call(this)
  //          }
  //        } break
...
function _onKeyUpInputB(event) {
  ...
  //      }
  //      else {
  //        const { h, s, v } = this.color.RGBtoHSV(r, value, b)
  //        this.color.h = h
  //        this.color.s = s
  //        this.color.v = v
  //        _updateColorView.call(this)
  ...
  //      }
  //      else {
  //        const { s, v } = this.color.HSLtoHSV(this.color.h, value, l)
  //        this.color.s = s
  //        this.color.v = v
  //        _updateColorView.call(this)
  //      }
...
function _onMouseMoveHueSlider(event) {
  ...
  this.color.h = Math.round(((thumbX + sliderThumbHalfWidth) / sliderRect.width) * 360)
