...
const _core_ = {
  updateColor: function(x, y) {
    ...
    this._c.hsv.s = Math.round((x / paletteWidth) * 100)
    this._c.hsv.v = Math.round(((paletteHeight - y) / paletteHeight) * 100)
  },
  ...
  updateHEXColor: function() {
    const { r, g, b } = this._c.rgb = this._c.toRGB()
    let hex = this._c.RGBtoHEX(r, g, b)
    if (this._c.a < 1) {
      hex += Math.round(this._c.a * 255).toString(16).padStart(2, 0)
    }
    this._c.hex = hex
  },
  getColorText: function() {
    switch (this.currentRepresentation) {
      case RGB:
        const { r, g, b } = this._c.rgb
        return `rgba(${Math.round(r)}, ${Math.round(g)}, ${Math.round(b)}, ${this._c.a})`
        
      case HSV: {
        const { h, s, v } = this._c.hsv
        return `hsva(${Math.round(h)}, ${Math.round(s)}%, ${Math.round(v)}%, ${this._c.a})`
      }
  
      case HSL: {
        const { h, s, l } = this._c.hsl
        return `hsla(${Math.round(h)}, ${Math.round(s)}%, ${Math.round(l)}%, ${this._c.a})`
      }
...
const _gui_ = {
  ...
  updateOpacityThumb: function() {
    ...
    opacityThumb.style.setProperty("transform", `translate(${(this._c.a * opacitySlider.offsetWidth) - (opacityThumb.offsetWidth / 2)}px, -50%)`)
  },
  updateHueThumb: function() {
    const { hueThumb, hueSlider } = this.DOM
    hueThumb.style.setProperty("transform", `translate(${((this._c.hsv.h / 360) * hueSlider.offsetWidth) - (hueThumb.offsetWidth / 2)}px, -50%)`);
  },
  setQuadrupedValue: function(a, b, c) {
    this.DOM["inputA"].value = a
    this.DOM["inputB"].value = b
    this.DOM["inputC"].value = c
    this.DOM["inputAlpha"].value = this._c.a
  },
  updateHEXInput: function() {
    this.DOM["inputHEX"].value = this._c.hex
  },
  ...
  updateInputs: function() {
    switch (this.currentRepresentation) {
      ...
      case HSL: {
        const { h, s, l } = this._c.hsl = this._c.toHSL()
  ...
  updateColorView: function() {
    const alpha = this._c.a
    const hsl = this._c.toHSL()
  ...
  updateHEXColorSection: function(color, event, con, conValue, op, startSelect, endSelect) {
    const { target } = event
    const { rgb, hex } = this._c
    if (con(rgb[color], conValue)) {
      rgb[color] = op(rgb[color], 1)
      this._c.hex = hex.substring(0, startSelect) + rgb[color].toString(16).padStart(2, '0') + hex.substring(endSelect)
      const { r, g, b  } = rgb
      this._c.hsv = this._c.RGBtoHSV(r, g, b)
      _gui_.rgbUpdateView.call(this)
    }
    target.value = this._c.hex
  ...
  updateHEXAlphaSection: function(event, con, conValue, op) {
    ...
    const { hex, a } = this._c
    if (con(a, conValue)) {
      this._c.a = parseFloat(op(a, 0.01).toFixed(2))
      target.value = this._c.hex = hex.substring(0, 7) + Math.round(this._c.a * 255).toString(16).padStart(2, '0')
      _gui_.updateColorView.call(this)
      _gui_.updateOpacityThumb.call(this)
    }
    target.value = this._c.hex
...
const _event_ = {
  ...
  onFocusInput: function() {
    switch (this.currentRepresentation) {
      case RGB:
        this._c.rgb = this.getRGB()
      break
      case HSV:
        this._c.hsv = this.getHSV()
      break
      case HSL:
        this._c.hsl = this.getHSL()
      break
      case HEX:
        _core_.updateHEXColor.call(this)
      break
    ...
    switch (key) {
      case "ArrowUp": {
        if(a < 1) {
          ...
          target.value = this._c.a = alphaValue
          _gui_.updateColorView.call(this)
          _gui_.updateOpacityThumb.call(this)
        }
      } break;
  ...
  onInputHEX: function(event) {
    ...
    if (/^#([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/i.test(value)) {
      const { r, g, b, a  } = this._c.HEXtoRGBA(value)
      this._c.a = a / 255
      this._c.rgb = { r, g, b }
      let hex = this._c.RGBtoHEX(r, g, b)
      if (this._c.a < 1) {
  ...
  onChangeInputHEX: function(event) {
    event.target.value = this._c.hex
  },
  onKeyDownInputA: function(event) {
    ...
    switch (key) {
      case "ArrowUp": {
        switch (this.currentRepresentation) {
          case RGB: {
            let { r, g, b } = this._c.rgb
            if (r < 255) {
              this._c.rgb.r = target.value = ++r
              this._c.hsv = this._c.RGBtoHSV(r, g, b)
              _gui_.rgbUpdateView.call(this)
            }
          } break
  ...
  onInputA: function(event) {
    ...
    if (/^(\d{1,3})(°?)$/.test(value)) {
      switch (this.currentRepresentation) {
        case RGB: {
          const { g, b } = this._c.rgb
          if(!isNaN(value) && value >= 0 && value <= 255) {
            this._c.rgb.r = value
            this._c.hsv = this._c.RGBtoHSV(value, g, b)
            _gui_.updateColorView.call(this)
            _gui_.updateHueThumb.call(this)
            _gui_.updateCursorPalette.call(this)
          }
        ...
        case HSL: {
          if (!isNaN(value) && value >= 0 && value <= 360) {
            this._c.hsv.h = this._c.hsl.h = value
            _gui_.updateColorView.call(this)
            _gui_.updateHueThumb.call(this)
          }
        } break
        ...
        switch (this.currentRepresentation) {
          ...
          case HSL: {
            ...
            if (s < 100) {
              target.value = ++hsl_s + "%"
              this._c.hsl.s = hsl_s
              this._c.hsv.s = this._c.HSLtoHSV(h, hsl_s, l).s
              _gui_.updateColorView.call(this)
              _gui_.updateCursorPalette.call(this)
            }
          } break
  ...
  onInputB: function(event) {
    ...
    if (/^(\d{1,3})(%?)$/.test(value)) {
      switch (this.currentRepresentation) {
        case RGB: {
          const { r, b } = this._c.rgb
          if(!isNaN(value) && value >= 0 && value <= 255) {
            this._c.rgb.g = value
            this._c.hsv = this._c.RGBtoHSV(r, value, b)
            _gui_.updateColorView.call(this)
            _gui_.updateHueThumb.call(this)
            _gui_.updateCursorPalette.call(this)
          }
        ...
        case HSL: {
          const { h, l } = this._c.hsl
          if(!isNaN(value) && value >= 0 && value <= 100) {
            this._c.hsl.s = value
            this._c.hsv = this._c.HSLtoHSV(h, value, l)
            _gui_.updateColorView.call(this)
            _gui_.updateCursorPalette.call(this)
          }
        } break
        ...
        switch (this.currentRepresentation) {
          ...
          case HSL: {
            ...
            if (hsl_l < 100) {
              target.value = ++hsl_l + "%"
              this._c.hsl.l = hsl_l
              this._c.hsv.v = this._c.HSLtoHSV(h, s, hsl_l).v
              _gui_.updateColorView.call(this)
              _gui_.updateCursorPalette.call(this)
            }
          } break
  ...
  onInputC: function(event) {
    ...
    if(/^(\d{1,3})(%?)$/.test(value)) {
      switch (this.currentRepresentation) {
        case RGB: {
          const { r, g } = this._c.rgb
          if(!isNaN(value) && value >= 0 && value <= 255) {
            this._c.rgb.b = value
            this._c.hsv = this._c.RGBtoHSV(r, g, value)
            _gui_.updateColorView.call(this)
            _gui_.updateHueThumb.call(this)
            _gui_.updateCursorPalette.call(this)
          }
        ...
        case HSL: {
          const { h, s } = this._c.hsl
          if(!isNaN(value) && value >= 0 && value <= 100) {
            this._c.hsl.l = value
            this._c.hsv = this._c.HSLtoHSV(h, s, value)
            _gui_.updateColorView.call(this)
            _gui_.updateCursorPalette.call(this)
          }
        } break
  ...
  onMouseMoveHueSlider: function(event) {
    ...
    this._c.hsv.h = Math.round(((thumbX + sliderThumbHalfWidth) / sliderRect.width) * 360)
  ...
  onMouseMoveOpacitySlider: function(event) {
    ...
    this._c.a = parseFloat(((thumbX + opacityThumbHalfWidth) / opacitySliderRect.width).toFixed(2))
