...
const _gui_ = {
  ...
  buildColorInputs: function() {
    ...
    inputsSwitch.style.setProperty("background-image", `url("data:image/svg+xml,%3Csvg width='16' height='16' viewBox='-203 292.3 12 12'%3E%3Cpath fill='%23bcbcbc' d='m-200.5 300.9 1.2-1.2 2.3 2.3 2.3-2.3 1.2 1.2-3.5 3.4-3.5-3.4zM-197 292.3l3.5 3.4-1.2 1.2-2.3-2.3-2.3 2.3-1.2-1.2 3.5-3.4z'/%3E%3C/svg%3E")`)
...
const _event_ = {
  ...
  onClickCopyColor: function() {
    ...
    this.DOM.copyColor.style.setProperty("background-image", `url("data:image/svg+xml,%3Csvg viewBox='0 0 16 16' width='14' height='14'%3E%3Cpath fill='%23bcbcbc' d='M15.2 4.7c.3-.3.2-.7-.1-1l-.8-.8c-.3-.3-.7-.2-1 .1l-6.7 7.5-4.1-3.8c-.3-.3-.7-.2-1 .1l-.8.8c-.3.3-.2.7.1 1l5.5 5c.3.3.7.2 1-.1l7.9-8.8z'/%3E%3C/svg%3E")`)
