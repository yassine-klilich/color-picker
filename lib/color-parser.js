  ...
  const _colorParser = Object.freeze({
    parse: function (color) {
      ...
      if (typeof color == "string" || color instanceof String) {
        ...
        throw new Error(
          "COLOR_CONVERT_ERR:: the provided RGB object has invalid values, please make sure red, green, blue are between 0 and 255 and the alpha color is between 0 and 1"
        )
      }
