...
Color.prototype.RGBtoHEX = function(r, g, b, a) {
	r = Math.round(r).toString(16).padStart(2, '0')
	g = Math.round(g).toString(16).padStart(2, '0')
	b = Math.round(b).toString(16).padStart(2, '0')
  a = (a == 1) ? "" : Math.round(a * 255).toString(16).padStart(2, '0')

	return "#" + r + g + b + a
}

Color.prototype.RGBtoHSV = function(r, g, b, a) {
	r /= 255, g /= 255, b /= 255
...
Color.prototype.HSLtoHSV = function(h, s, l, a) {
...
Color.prototype.HEXtoRGB = function(hex) {
    ...
    if (hex.length < 6) {
      ...
      a = (splitHexValues[4] ? (+("0x" + splitHexValues[4] + splitHexValues[4]) / 255) : 1)
    }
      ...
      a = (splitHexValues[7] ? (+("0x" + splitHexValues[7]) / 255) : 1)
    }
