...
ColorPicker.prototype.open = function () {
	this.isOpen = true
	const color = ColorParser.parse(this.value)
	this._c.hsv = color
...
ColorPicker.prototype.getRGB = function () {
	return { ...this._c.toRGB(), a: this._c.a }
}
...
ColorPicker.prototype.getHEX = function () {
	let hex = this._c.toHEX()
  if (this._c.a < 1) {
    const alpha = Math.round(this._c.a * 255).toString(16)
